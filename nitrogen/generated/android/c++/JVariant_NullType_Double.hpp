...
namespace margelo::nitro::playagerangedeclaration {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/playagerangedeclaration/Variant_NullType_Double;";
  ...
  namespace JVariant_NullType_Double_impl {
    class First: public jni::JavaClass<First, JVariant_NullType_Double> {
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/playagerangedeclaration/Variant_NullType_Double$First;";
    ...
    class Second: public jni::JavaClass<Second, JVariant_NullType_Double> {
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/playagerangedeclaration/Variant_NullType_Double$Second;";
