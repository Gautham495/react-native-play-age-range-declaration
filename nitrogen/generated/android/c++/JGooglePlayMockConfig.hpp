...
namespace margelo::nitro::playagerangedeclaration {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "GooglePlayMockConfig" and the the Kotlin data class "GooglePlayMockConfig".
   */
  struct JGooglePlayMockConfig final: public jni::JavaClass<JGooglePlayMockConfig> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/playagerangedeclaration/GooglePlayMockConfig;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct GooglePlayMockConfig by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    GooglePlayMockConfig toCpp() const {
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JGooglePlayMockConfig::javaobject> fromCpp(const GooglePlayMockConfig& value) {
      using JSignature = JGooglePlayMockConfig(jni::alias_ref<JPlayAgeSignalsUserStatus>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>);
      static const auto clazz = javaClassStatic();
