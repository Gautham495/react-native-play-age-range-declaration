...
open class HybridPlayAgeRangeDeclarationSpec_cxx {
  ...
  @inline(__always)
  public final func isEligibleForAgeFeatures() -> bridge.Result_std__shared_ptr_Promise_bool___ {
    do {
      let __result = try self.__implementation.isEligibleForAgeFeatures()
