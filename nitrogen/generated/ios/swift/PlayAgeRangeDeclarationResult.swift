...
public extension PlayAgeRangeDeclarationResult {
   ...
   */
  init(isEligible: Bool, installId: String?, userStatus: PlayAgeRangeDeclarationUserStatus?, error: String?, ageLower: Double?, ageUpper: Double?, mostRecentApprovalDate: String?) {
    ...
    }(), { () -> bridge.std__optional_PlayAgeRangeDeclarationUserStatus_ in
      if let __unwrappedValue = userStatus {
        return bridge.create_std__optional_PlayAgeRangeDeclarationUserStatus_(__unwrappedValue)
      } else {
        return .init()
      }
  ...
  @inline(__always)
  var userStatus: PlayAgeRangeDeclarationUserStatus? {
